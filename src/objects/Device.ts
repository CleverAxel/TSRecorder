...
export class Device {
    ...
    getStatusIfGotCorrectPermissionsToRecord(deviceDetails:{audio:IDeviceDetails, video:IDeviceDetails}) {
    ...
    public askPermissions():Promise<{audio:IDeviceDetails, video:IDeviceDetails}> {
